...
"""Exercice 1. Classification avec SVM RBF"""
...
svm_model = svm.SVC(kernel='rbf', probability=True) #creation d'une instance du modele SVM RBF
...
# 7. Évaluation avec les différentes metrics
...
# 8. Calcul du ROC-AUC
y_pred_prob = svm_model.decision_function(X_test) # Le ROC_AUC utilise des probabilites ou des scores de décision
