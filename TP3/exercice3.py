...
"""Exercice 3. Approche Logisticregression: Naïve Bayes"""
# 1. Chargement du fichier CSV avec le bon encodage
data = pd.read_csv('./sms_spam.csv', encoding='latin1') 

# 2. Prétraitement des données
# Nettoyage des données
data = data[['v1', 'v2']]  # Garder uniquement les colonnes nécessaires pas les Nan
...
y_pred = log_reg.predict(X_test)  # Prédire sur l'ensemble de test
